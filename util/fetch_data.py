...
def fetch_data(coin: str, comparison_currency: str):
    # Input your own coinlib api key here
    API_KEY: str = "12456789"

    API_URL: str = "https://coinlib.io/api/v1/coin?key={API_KEY}&pref={comparison_currency}&symbol={coin}".format(
